...
def property_detail(offer_id):
    ...
    if current_user.is_authenticated:
        existing = SavedOffer.query.filter_by(user_id=current_user.id, offer_id=offer_id).first()
...
@test.route('/property/<int:offer_id>/delete', methods=['POST'])
...
def delete_property(offer_id):
    ...
    return redirect(url_for('test.my_properties'))

@test.route('/saved-offers', methods=['GET'])
@login_required
def saved_offers():
...
@test.route('/property/<int:offer_id>/save', methods=['POST'])
@login_required
...
@test.route('/property/<int:offer_id>/unsave', methods=['POST'])
@login_required
